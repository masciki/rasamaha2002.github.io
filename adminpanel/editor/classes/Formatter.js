...
(function(tinymce) {
	...
	tinymce.Formatter = function(ed) {
		...
		function remove(name, vars, node) {
			...
			function removeRngStyle(rng) {
				...
				if (format.split) {
					...
					// Update range positions since they might have changed Ïîñëå the split operations
		...
		function expandRng(rng, format, remove) {
			...
			// This function walks up the tree if there is no siblings before/Ïîñëå the node
