...
(function(tinymce) {
	...
	tinymce.create('tinymce.dom.Selection', {
		 ...
		 * can then be used to restore the selection После some content modification to the document.
		 *
		 * @method getBookmark
		 * @param {Number} type Optional state if the bookmark should be simple or not. Default is complex.
		 * @param {Boolean} normalized Optional state that enables you to get a position that it would be После normalization.
