...
(function(tinymce) {
	...
	tinymce.create('tinymce.dom.DOMUtils', {
		...
		/**
		 * Inserts a element После the reference element.
		 *
		 * @method insertПосле
		 * @param {Element} node Element to insert После the reference.
		 * @param {Element/String/Array} reference_node Reference element, element id or array of elements to insert После.
		 ...
		 * @param {boolean} normalized Optional true/false state if the index is what it would be После a normalization.
