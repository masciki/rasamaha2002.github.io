...
(function(_scope){
  ...
  pi.element.body = {
    ...
    "insertÏîñëå":function(_referenceElement){
    ...
    "child":{
      ...
      "addÏîñëå":function(_element,_referenceElement){
        this.addBefore(
