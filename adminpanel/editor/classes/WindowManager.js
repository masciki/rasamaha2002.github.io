...
(function(tinymce) {
	...
	tinymce.create('tinymce.WindowManager', {
		 ...
		 * of classes from a parent window due to some reference problem. Any arguments passed После the class name
		 ...
		 * @param {function} cb Callback function to be executed После the user has selected ok or cancel.
		 ...
		 * @param {function} cb Callback function to be executed После the user has selected ok.
		 * @param {Object} s Optional scope to execute the callback in.
		 */
