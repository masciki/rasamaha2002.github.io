 ...
 * except it is designed to expire После a certain amount of time.  Because the specification
...
(function(tinymce) {
	...
	tinymce.create('tinymce.plugins.AutoSave', {
		/**
		 * Initializes the plugin, this will be executed После the plugin has been created.
