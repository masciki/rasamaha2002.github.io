...
if($_GET['action'] == "edit") {
	...
	$cfgWriteEntersIp				= htmlspecialchars($_POST['cfgWriteEntersIp'], ENT_QUOTES, '');
	mysql_query('UPDATE `settings` SET `data` = "'.$cfgWriteEntersIp.'" WHERE cfgname = "cfgWriteEntersIp" LIMIT 1');
	...
	$cfgAPImaxwith			= sprintf("%01.2f", $_POST['cfgAPImaxwith']);
	mysql_query('UPDATE `settings` SET `data` = "'.$cfgAPImaxwith.'" WHERE cfgname = "cfgAPImaxwith" LIMIT 1');
	...
	$cfgBitcoinSecretKey			= htmlspecialchars($_POST['cfgBitcoinSecretKey'], ENT_QUOTES, '');
	mysql_query('UPDATE `settings` SET `data` = "'.$cfgBitcoinSecretKey.'" WHERE cfgname = "cfgBitcoinSecretKey" LIMIT 1');
	
	$cfgBitcoin			= htmlspecialchars($_POST['cfgBitcoin'], ENT_QUOTES, '');
	mysql_query('UPDATE `settings` SET `data` = "'.$cfgBitcoin.'" WHERE cfgname = "cfgBitcoin" LIMIT 1');
	
	$cfgAutoPayBT			= htmlspecialchars($_POST['cfgAutoPayBT'], ENT_QUOTES, '');
	mysql_query('UPDATE `settings` SET `data` = "'.$cfgAutoPayBT.'" WHERE cfgname = "cfgAutoPayBT" LIMIT 1');
	
	$cfgBitcoinAPIguid			= htmlspecialchars($_POST['cfgBitcoinAPIguid'], ENT_QUOTES, '');
	mysql_query('UPDATE `settings` SET `data` = "'.$cfgBitcoinAPIguid.'" WHERE cfgname = "cfgBitcoinAPIguid" LIMIT 1');
	
	$cfgBitcoinAPIpass			= htmlspecialchars($_POST['cfgBitcoinAPIpass'], ENT_QUOTES, '');
	mysql_query('UPDATE `settings` SET `data` = "'.$cfgBitcoinAPIpass.'" WHERE cfgname = "cfgBitcoinAPIpass" LIMIT 1');
...
<tr bgcolor="#dddddd">
	<td><b>Отслеживатель IP</b>:</td>
	<td align="right"><label><input type="radio" name="cfgWriteEntersIp" value="on" <?php if(cfgSET('cfgWriteEntersIp') == "on") { print ' checked="checked"'; } ?> /> <font color="green">Включить</font></label> / <label><input type="radio" name="cfgWriteEntersIp" value="off" <?php if(cfgSET('cfgWriteEntersIp') == "off") { print ' checked="checked"'; } ?> /> <font color="red">Выключить</font></label></td>
	<td width="18"><img style="cursor: help;" src="images/help_ico.png" width="16" height="16" border="0" alt="Включить отслеживание IP на сайте." /></td>
</tr>
<tr bgcolor="#eeeeee">
...
<tr bgcolor="#eeeeee">
	<td><b>Максимальный вывод через API</b>:</td>
	<td align="right"><input style="width: 295px;" type="text" name="cfgAPImaxwith" size="70" maxlength="250" value="<?php print cfgSET('cfgAPImaxwith'); ?>" /></td>
	<td width="18"><img style="cursor: help;" src="images/help_ico.png" width="16" height="16" border="0" alt="Укажите максимально разрешенную сумму для вывода через API за один раз. Если указать 0, тогда сумма будет неограничена." /></td>
</tr>
...
<tr bgcolor="#cccccc">
	<td height="25" colspan="3" align="center"><b style="color: #999999;">НАСТРОЙКА BITCOIN</b></td>
</tr>

<tr bgcolor="#dddddd">
	<td><b>Кошелек Bitcoin</b>:</td>
	<td align="right"><input style="width: 295px;" type="text" name="cfgBitcoin" size="70" maxlength="250" value="<?php print cfgSET('cfgBitcoin'); ?>" /></td>
	<td width="18"><img style="cursor: help;" src="images/help_ico.png" width="16" height="16" border="0" alt="Кошелек биткоин(Пример:17s5Z4PejffjFEUL2m8DVpf4PZB9ERzwEt)" /></td>
</tr>
<tr bgcolor="#eeeeee">
	<td><b>Секретный ключ</b>:</td>
	<td align="right"><input class="input" style="width: 295px;" type="text" name="cfgBitcoinSecretKey" size="70" maxlength="250" value="<?php print cfgSET('cfgBitcoinSecretKey'); ?>" /></td>
	<td width="18"><img style="cursor: help;" src="images/help_ico.png" width="16" height="16" border="0" alt="Секретный ключ (Можно свой)" /></td>
</tr>
...
<tr bgcolor="#cccccc">
	<td height="25" colspan="3" align="center"><b style="color: #999999;">НАСТРОЙКА PERFECTMONEY API</b></td>
</tr>
<tr bgcolor="#dddddd">
...
<tr bgcolor="#cccccc">
	<td height="25" colspan="3" align="center"><b style="color: #999999;">НАСТРОЙКА PAYEER API</b></td>
</tr>
...
<tr bgcolor="#cccccc">
	<td height="25" colspan="3" align="center"><b style="color: #999999;">НАСТРОЙКА BITCOIN API</b></td>
</tr>

<tr bgcolor="#dddddd">
	<td><b>Автовыплаты Bitcoin</b>:</td>
	<td align="right"><label><input type="radio" name="cfgAutoPayBT" value="on" <?php if(cfgSET('cfgAutoPayBT') == "on") { print ' checked="checked"'; } ?> /> <font color="green">Включить</font></label> / <label><input type="radio" name="cfgAutoPayBT" value="off" <?php if(cfgSET('cfgAutoPayBT') == "off") { print ' checked="checked"'; } ?> /> <font color="red">Выключить</font></label></td>
	<td width="18"><img style="cursor: help;" src="images/help_ico.png" width="16" height="16" border="0" alt="Если вы включите автовыплаты, средства будут направляться автоматически пользователям после подачи заявки. Если отключите, то все заявки будут направлены на проверку администрации и будут доступны в разделе: Бухгалтерия" /></td>
</tr>
<tr bgcolor="#eeeeee">
	<td><b>ID аккаунта Bitcoin(GUID)</b>:</td>
	<td align="right"><input style="width: 295px;" type="text" name="cfgBitcoinAPIguid" size="70" maxlength="250" value="<?php print cfgSET('cfgBitcoinAPIguid'); ?>" /></td>
	<td width="18"><img style="cursor: help;" src="images/help_ico.png" width="16" height="16" border="0" alt="Введите ваш ID в системе Bitcoin(blockchain). Необходим для авторизации по API." /></td>
</tr>
<tr bgcolor="#dddddd">
	<td><b>Пароль аккаунта Bitcoin</b>:</td>
	<td align="right"><input style="width: 295px;" type="text" name="cfgBitcoinAPIpass" size="70" maxlength="250" value="<?php print cfgSET('cfgBitcoinAPIpass'); ?>" /></td>
	<td width="18"><img style="cursor: help;" src="images/help_ico.png" width="16" height="16" border="0" alt="Укажите ваш пароль от аккаунта Bitcoin(blockchain)" /></td>
</tr>
