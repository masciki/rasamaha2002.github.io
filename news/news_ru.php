						...
						<article class="widget">
							<header class="widget__header one-btn">
								<div class="widget__title" style="width: 100%;">
									<i class="pe-7f-news-paper"></i><h3>Новости</h3>
								</div>
							</header>
							<div class="widget__content table-responsive">
								<table class="table table-striped media-table">
							  	<thead>
							  		<tr>
							  			<th width="270">Название</th>
							  			<th width="120">Дата</th>
							  			<th>Описание</th>
										<?php if($status == 1){?><th>Ред.</th><?php }?>
							  		</tr>
							  	</thead>
							  	<tbody>
<?php
...
function topics_list($page, $num, $status)
{
	...
	print "<div class=\"pages\" style=\"background: rgba(0,0,0,0.25); margin-bottom: 1px; padding: 5px;\"><b>Страницы:  </b>".$pervpage.$page2left.$page1left." <b style=\"font-size:19px;\">".$page."</b> ".$page1right.$page2right.$nextpage."</div>";
}
